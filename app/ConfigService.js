...
ConfigService.prototype.property = function(elem, key, value) {
...
ConfigService.prototype.add = function(defaults) {
	this.data.push(defaults);
};

ConfigService.prototype.count = function() {
	console.log("this-config", this);
	return this.data.length;
};

ConfigService.prototype.getFromIndex = function(configIdx) {
	return this.data[configIdx];
}

ConfigService.prototype.getIndexFromId = function(id) {
	for (i in this.data) {
...
ConfigService.prototype.getFromId = function(id) {
	for (i in this.data) {
...
ConfigService.prototype.removeGadget = function(id) {
...
ConfigService.prototype.load = function(callback) {
...
ConfigService.prototype.setConfig = function(data, callback) {
